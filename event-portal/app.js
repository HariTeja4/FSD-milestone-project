...
const SAMPLE_EVENTS = [
  {
    id: 1, title: 'Tech Symposium 2026', category: 'Technical',
    emoji: '🖥️', color: '#1A1A3E',
    date: '2026-04-12', time: '09:00 AM', venue: 'Main Auditorium',
  ...
  },
  {
    ...
    emoji: '⚡', color: '#1A1E2E',
    date: '2026-04-19', time: '08:00 AM', venue: 'Innovation Hub',
  ...
  },
  {
    ...
    emoji: '🎭', color: '#2E1A1A',
    date: '2026-05-03', time: '05:00 PM', venue: 'Open Air Theatre',
  ...
  },
  {
    ...
    emoji: '🤖', color: '#1A2E1A',
    date: '2026-04-25', time: '10:00 AM', venue: 'ECE Lab Complex',
  ...
  },
  {
    ...
    emoji: '🏆', color: '#1E2A1A',
    date: '2026-05-15', time: '07:00 AM', venue: 'Sports Complex',
  ...
  },
  {
    ...
    emoji: '🧠', color: '#1A1A3E',
    date: '2026-06-01', time: '10:00 AM', venue: 'Seminar Hall A',
  ...
  },
  {
    ...
    emoji: '💼', color: '#2A1E0E',
    date: '2026-05-20', time: '11:00 AM', venue: 'Seminar Hall B',
  ...
  },
  {
    ...
    emoji: '📸', color: '#2E1A2E',
    date: '2026-05-08', time: '09:00 AM', venue: 'Art Gallery Hall',
  ...
  events.forEach((ev, i) => {
    ...
    card.innerHTML = `
      ...
      <div class="ec-body">
        ...
        <div class="ec-desc">${(ev.description || ev.desc || '').substring(0, 90)}</div>
        <div class="ec-meta">
...
function openEventDetail(ev) {
  ...
  c.innerHTML = `
   ...
   <div class="em-desc">${ev.description || ev.desc}</div>
    <div class="em-grid">
